...
!!!134786.java!!!	addPlaquette(inout movie : Movie) : void
...
!!!135554.java!!!	getXToScroll(in targetID : int) : int
        int x = -paddingX;
        ...
        return x;
!!!135682.java!!!	getCurrentPlaquette() : View
        return getPlaquette(getCurrentPlaquetteID());
!!!135810.java!!!	getPlaquette(in index : int) : View
        return flowLayout.getChildAt(index);
!!!135938.java!!!	getCurrentPlaquetteID() : int
